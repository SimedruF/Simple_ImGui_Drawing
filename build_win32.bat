...
@set OUT_DIR=Debug
@set OUT_EXE=ImGuiSimpleDrawApp
@set INCLUDES=/I.\imgui\ /I.\imgui\backends\ /I "%DXSDK_DIR%/Include"
@set SOURCES= main.cpp ImGuiSimpleDrawApp.cpp .\imgui\backends\imgui_impl_dx9.cpp .\imgui\backends\imgui_impl_win32.cpp .\imgui\imgui*.cpp
